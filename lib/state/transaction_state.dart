  ...
  void _initializeMockTransactions() {
    ...
    final mockTransactions = [
      ...
      Transaction(
        ...
        status: TransactionStatus.success,
        amount: 1500,
        title: 'To Rahul Kumar',
        subtitle: 'rahul.k@okaxis',
        recipientName: 'Rahul Kumar',
        recipientUpi: 'rahul.k@okaxis',
      ...
      Transaction(
        ...
        amount: 185000,
        title: 'Salary Credit',
        subtitle: 'TechCorp India Pvt Ltd',
        category: 'Income',
        sourceAccount: 'HDFC Savings •• 1234',
      ...
      Transaction(
        ...
        status: TransactionStatus.success,
        amount: 25000,
        title: 'To Priya Sharma',
        subtitle: 'priya.s@upi',
        recipientName: 'Priya Sharma',
        recipientUpi: 'priya.s@upi',
        category: 'Transfers',
        sourceAccount: 'HDFC Savings •• 1234',
